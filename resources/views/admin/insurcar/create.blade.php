<h1> Registrar nuevo seguro</h1>
<form class="mt-8" method="POST" action="/admin/insurcar"  role="form">
  @csrf
    ...
    <div class="col-md-4">
      ...
      <div class="input-group has-validation">
        <input type="text" class="form-control" id="validationCustomUsername" name="characteristic"  aria-describedby="inputGroupPrepend" required>
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control" id="validationCustom03" name="cost"   required>
      <div class="invalid-feedback">
