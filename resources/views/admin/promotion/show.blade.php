...
<form class="mt-8" method="POST" action="/admin/promotion/{{$promotion->id}}"  role="form">
  ...
  @method('DELETE')
    <div class="col-md-4">
      ...
      <input type="text" class="form-control" id="validationCustom02" name="type" value="{{$promotion->type}}" disabled>
    ...
    <div class="col-md-4">
      ...
      <div class="input-group has-validation">
        <input type="text" class="form-control" id="validationCustomUsername" name="detail" value="{{$promotion->detail}}" aria-describedby="inputGroupPrepend" disabled>
    ...
    <div class="col-md-6">
      ...
      <input type="date" class="form-control" id="validationCustom03" name="validity" value="{{$promotion->validity }}" disabled>
      <div class="invalid-feedback">
