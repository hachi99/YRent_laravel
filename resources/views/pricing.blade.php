...
<!------ inicio del contenido---->
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/a4.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <h1 class="mb-3 bread">Precios Y Flota</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section ftco-cart">
	    				...
	    				<table class="table ">
						    <thead class="thead-primary">
						      <tr class="text-center">
						        <th>&nbsp;</th>
						        <th class="bg-secondary heading">Descripcion <br>del vehiculo</th>
								<th class="bg-secondary heading">Puertas</th>
								<th class="bg-secondary heading">Pasajeros</th>
						        <th class="bg-primary heading px-5">Precio</th>
								<th class="bg-secondary heading">Calificación</th>
							...
							@foreach($flots as $flot)
						      <tr class="">
						      	<td>
									<img src="{{ asset('storage/flot/'.$flot->pic)}}" style="width:230px">
								</td>
								<td class= "text-center"> {{($flot['details'])}}
								<td class= "text-center"> {{($flot['doors'])}}
								<td class= "text-center"> {{($flot['passenger'])}}
						
						        <td class="price">
						        	<p class="btn-custom "><a href="booking">Reservar</a></p>
						        	<div class="price-rate">
							        	<h3>
							        		<span class="num"><small class="currency">$</small> {{($flot['cost'])}} </span>
			...
			<p class="font-weight-light px-4 py-5">*Imagenes solo de referencia, el auto rentado puede variar <br> en color o marca</p>
		</section>
