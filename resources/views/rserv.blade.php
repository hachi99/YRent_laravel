...
<html lang="en">
  <head>
    <title>YRent - Ver estatus de reserva</title>
...
<!------ inicio del contenido---->
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a href="Precios" class="nav-link">Precios y Flota</a></li>
				<li class="nav-item"><a href="ubic" class="nav-link">Ubicación</a></li>
				<li class="nav-item active"><a href="#" class="nav-link">Ver reservación</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Inicio <i class="ion-ios-arrow-forward"></i></a></span> <span>ver reservación <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">Ver estatus de reserva</h1>
          </div>
        </div>
      </div>
    </section>

    <section class="ftco-section contact-section justify-content-center">
      <div class="container">
        <div class="row d-flex mb-5 contact-info justify-content-center">
          <div class="col-md-8 block-9 mb-md-5 justify-content-center">
            <form action="#" class="bg-light p-5 contact-form justify-content-center">
              <h2 class="font-weight-normal">Ingresa los siguientes datos<br>para verificar el estatus de tu reserva*</h2> 
              ...
              <div class="form-group">
                <input type="text" class="form-control" placeholder="ID de Reserva">
              </div>
              <button type="submit" class="btn btn-success">Buscar</button>
              <h7 class="font-weight-light py-2"> <br> *Deben estar en el correo de confirmación o en el ticket de reserva</h7>
            </form>
